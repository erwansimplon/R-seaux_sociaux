...
$msg="SELECT DISTINCT * from messages where msg_id=$id_msg";
...
$msql=mysql_query($msg);
  ...
  $suppr_msg = mysql_query("DELETE FROM messages WHERE msg_id=$id_msg");
  echo $msg;
...
$comm="SELECT DISTINCT * from comments where msg_id_fk=$id_msg";
  ...
  //bug a corrigé les 2 boucles while on un confli
    ...
    $suppr_comm = mysql_query("DELETE FROM comments WHERE msg_id_fk=$id_msg");
