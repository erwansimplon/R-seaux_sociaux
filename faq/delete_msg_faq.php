...
$msg="SELECT DISTINCT * from faq where msg_id=$id_msg";
...
$msql=mysql_query($msg);
  ...
  $suppr_msg = mysql_query("DELETE FROM faq WHERE msg_id=$id_msg");
  echo $msg;
...
$comm="SELECT DISTINCT * from faq_comm where msg_id_fk=$id_msg";
  ...
  //bug a corrigé les 2 boucles while on un confli
    ...
    $suppr_comm = mysql_query("DELETE FROM faq_comm WHERE msg_id_fk=$id_msg");
