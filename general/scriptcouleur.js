$(document).ready(function() {
	...
	$('.button_1').click(function(){
	    $('.rech').addClass("recherche_pink");
			...
			$('.chat_head1').addClass("recherche_pink");
			$('.chat_head1').removeClass("recherche_red");
			$('.chat_head1').removeClass("recherche_green");
			$('.chat_head2').addClass("recherche_pink");
			$('.chat_head2').removeClass("recherche_red");
			$('.chat_head2').removeClass("recherche_green");
			$('.msg_head').addClass("recherche_pink");
			$('.msg_head').removeClass("recherche_red");
			$('.msg_head').removeClass("recherche_green");
			$('.msg_head1').addClass("recherche_pink");
			$('.msg_head1').removeClass("recherche_red");
			$('.msg_head1').removeClass("recherche_green");
			$('.msg_head2').addClass("recherche_pink");
			$('.msg_head2').removeClass("recherche_red");
			$('.msg_head2').removeClass("recherche_green");
			$('.image_loupe').attr('src','../auth-photos/d.png');
	...
	$('.button_2').click(function(){
			...
			$('.chat_head').removeClass("recherche_green");
			$('.chat_head1').addClass("recherche_red");
			$('.chat_head1').removeClass("recherche_pink");
			$('.chat_head1').removeClass("recherche_green");
			$('.chat_head2').addClass("recherche_red");
			$('.chat_head2').removeClass("recherche_pink");
			$('.chat_head2').removeClass("recherche_green");
			$('.msg_head').addClass("recherche_red");
			$('.msg_head').removeClass("recherche_pink");
			$('.msg_head').removeClass("recherche_green");
			$('.msg_head1').addClass("recherche_red");
			$('.msg_head1').removeClass("recherche_pink");
			$('.msg_head1').removeClass("recherche_green");
			$('.msg_head2').addClass("recherche_red");
			$('.msg_head2').removeClass("recherche_pink");
			$('.msg_head2').removeClass("recherche_green");
			$('.image_loupe').attr('src','../auth-photos/b.png');
	...
	$('.button_3').click(function(){
			...
			$('.chat_head').removeClass("recherche_red");
			$('.chat_head').removeClass("recherche_pink");
			$('.chat_head1').addClass("recherche_green");
			$('.chat_head1').removeClass("recherche_red");
			$('.chat_head1').removeClass("recherche_pink");
			$('.chat_head2').addClass("recherche_green");
			$('.chat_head2').removeClass("recherche_red");
			$('.chat_head2').removeClass("recherche_pink");
			$('.msg_head').addClass("recherche_green");
			$('.msg_head').removeClass("recherche_red");
			$('.msg_head').removeClass("recherche_pink");
			$('.msg_head1').addClass("recherche_green");
			$('.msg_head1').removeClass("recherche_red");
			$('.msg_head1').removeClass("recherche_pink");
			$('.msg_head2').addClass("recherche_green");
			$('.msg_head2').removeClass("recherche_red");
			$('.msg_head2').removeClass("recherche_pink");
			$('.image_loupe').attr('src','../auth-photos/c.png');
