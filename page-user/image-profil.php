...
//traitement de l'image
  ...
  /*Suppression de l'image*/
   ...
   if (file_exists('../photos/profil/'.$idlog.$image.'images.jpg')){
       echo '<div>
       <img align="middle" class="avatar" alt="avatar" src="../photos/profil/'.$idlog.$image.'images.jpg'.'"/>
   ...
   ?>
   <h2 class="button_effacer button_tel"><a href="<?php $hachage = $idlog;
