...
?>
  ...
  <head>
    <?php head_admin_plus_style(); ?>
  </head>

<div id="cadre" class="color_cadre_couverture_profil">
<h1>Télécharger une image</h1><br />

 <form enctype="multipart/form-data" action="#" method="post"
 onsubmit="Verif_attente('message_attente')" id="upload">
         <input class="button_pos_photo" name="uploadFile" type="file" /><br/>
         <input class="button_tel button_effacer" type="submit" name="photo" id="photo" value="Envoyer la photo" style="margin-left: 25.5%;" /><br/><br/>
 </form>
...
//traitement de l'image
 //dossier d'upload
 $dossier_upload = '../photos/couverture/';
...
/*Suppression de l'image*/
 ...
 if (file_exists('../photos/couverture/'.$id.$image.'images.jpg')){
     ...
     <img align="middle" class="avatar" alt="avatar" src="../photos/couverture/'.$id.$image.'images.jpg"/>
 ...
 ?>
 <h2 class="button_effacer button_tel"><a href="<?php $hachage = $_GET['id'];
                 $URL_NEWS = "page-user.php?id=".$hachage;
